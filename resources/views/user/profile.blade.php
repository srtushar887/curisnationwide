                                    ...
                                    <div class="side-bar">
                                        <div class="user-info">
                                            @if (!empty(Auth::user()->profile_image) && file_exists(Auth::user()->profile_image))
                                                <img class="img-profile img-circle img-responsive center-block" src="{{asset(Auth::user()->profile_image)}}" alt="Header Avatar">
                                            @else
                                                <img class="img-profile img-circle img-responsive center-block" src="https://www.meme-arsenal.com/memes/b6a18f0ffd345b22cd219ef0e73ea5fe.jpg" alt="Header Avatar">
                                            @endif
                                            <ul class="meta list list-unstyled">
                                                <li class="name text-left">Name
                                                    <br>
                                                    <label class="label label-info">{{Auth::user()->name}}</label>
                                                </li>
                                                <li class="name text-left">Email
                                                    <br>
                                                    <label class="label label-info">{{Auth::user()->email}}</label>
                                                </li>
                                                <li class="activity text-left">Last logged in:
                                                    <p>Today at 2:18pm</p></li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <fieldset class="fieldset">
                                                ...
                                                <div class="form-group avatar">
                                                    ...
                                                    <div class="form-inline col-md-10 col-sm-9 col-xs-12">
                                                        <input type="file" name="profile_image" class="file-uploader pull-left">
